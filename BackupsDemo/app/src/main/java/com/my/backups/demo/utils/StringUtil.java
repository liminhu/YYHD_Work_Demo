...
public class StringUtil {
	...
	/**
	 * getCharsFromByteArray作用： 把一个byte数组转成一个char数组
	 */
	...
	/**
	 * 方法1： hexStringtoByteArray1作用： 将一个指定的hex值的字符串转成一个byte的数组
	 */
	...
	/**
	 * 方法2： hexStringtoByteArray2作用： 将一个指定的hex值的字符串转成一个byte的数组
	 */
	...
	/**
	 * printByteArray作用： 输出一个字节数组当中的每一个字节
	 */
	...
	/**
	 * intChangeToByteArray int转 byte数组
	 */
