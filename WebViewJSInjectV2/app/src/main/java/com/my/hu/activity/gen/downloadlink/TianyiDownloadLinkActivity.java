...
import com.my.hu.webviewjsinjectv2.webview.TianyiWebViewClientBase;
...
public class TianyiDownloadLinkActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0) {
                ...
                num += db.saveUpdateStraightChainInfo(straightChainData, ConstantData.TB_TIANYI_CHAIN);
                db.closeDataBase();
                ...
                js.state=1;
                Log.i("hook_state",js.state+" md5:"+js.link_url);
                ...
                //暂时转main
                Intent intent=new Intent(TianyiDownloadLinkActivity.this, BaiduDownloadLinkActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewSqliteCreateRawLinkDB createDb = new NewSqliteCreateRawLinkDB(getBaseContext());
        UpdateSqliteRawLinkDBHelper db = new UpdateSqliteRawLinkDBHelper(createDb);
        jsonDataList = db.getLinkJsonDataListByPlatformNameAndState(ConstantData.TB_RAW_LINK, ConstantData.PLATFORM_TIANYI,0);
        db.closeDataBase();
        webView = new WebViewBase(getBaseContext());
        TianyiWebViewClientBase mWebViewClientBase = new TianyiWebViewClientBase(handler);
