...
public class TianyiPostActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                Intent intent=new Intent(TianyiPostActivity.this, BaiduPostActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonDatas = db.getStraightChainDataListByState(ConstantData.TB_TIANYI_CHAIN,0);
        ...
        for (int i = 0; i < jsonDatas.size(); i++) {
            ...
            urlInfo.state=1;
            db.needUpdateStraightChainDataInfo(urlInfo,ConstantData.TB_TIANYI_CHAIN);
        }
        db.closeDataBase();
        if(jsonDatas.size()==0){
            handler.sendEmptyMessage(0);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(TianyiPostActivity.this, MainActivity.class);
        startActivity(intent);
    }
}
