...
public class QH360PostActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                Intent intent=new Intent(QH360PostActivity.this, BaiduPostInvalidActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonDatas = db.getStraightChainDataListByState(ConstantData.TB_QH_360_CHAIN,0);
        ...
        for (int i = 0; i < jsonDatas.size(); i++) {
            ...
            urlInfo.state=1;
            db.needUpdateStraightChainDataInfo(urlInfo,ConstantData.TB_QH_360_CHAIN);
        }
        db.closeDataBase();
        if(jsonDatas.size()==0){
            handler.sendEmptyMessage(0);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(QH360PostActivity.this, MainActivity.class);
        startActivity(intent);
    }
}
