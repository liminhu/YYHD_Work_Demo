...
public class BaiduTwoPostActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                Intent intent=new Intent(BaiduTwoPostActivity.this, QH360PostActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("hook_onCreate","BaiduTwoPostActivity");
        ...
        jsonDatas = db.getStraightChainDataListOnlyByPlatformNameAndState(ConstantData.TB_BAIDU_CHAIN,ConstantData.PLATFORM_OLD_BAIDU,1);
        Map<String, String> map = null;
        for (int i = 0; i < jsonDatas.size(); i++) {
            StraightChainData urlInfo = jsonDatas.get(i);
            map = new LinkedHashMap<String, String>();
            map.put("key", urlInfo.md5);
            map.put("url", urlInfo.link_url);
            Log.i("hook_old_baidu",urlInfo.link_url);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(BaiduTwoPostActivity.this, MainActivity.class);
        startActivity(intent);
    }
}
