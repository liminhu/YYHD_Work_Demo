...
public class BaiduDownloadLinkActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0) {
                ...
                if (jsonDataList.size() > 0) {
                    ...
                    Intent intent = new Intent(BaiduDownloadLinkActivity.this, Qh360DownlinkActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewSqliteCreateRawLinkDB createDb = new NewSqliteCreateRawLinkDB(getBaseContext());
        UpdateSqliteRawLinkDBHelper db = new UpdateSqliteRawLinkDBHelper(createDb);
        jsonDataList = db.getLinkJsonDataListByPlatformNameAndState(ConstantData.TB_RAW_LINK, ConstantData.PLATFORM_BAIDU,0);
        db.closeDataBase();
        webView = new WebViewBase(getBaseContext());
        BaiduWebViewClientBase mWebViewClientBase = new BaiduWebViewClientBase(handler);
