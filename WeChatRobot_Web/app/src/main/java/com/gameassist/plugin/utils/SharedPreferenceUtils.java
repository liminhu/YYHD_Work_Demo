...
public class SharedPreferenceUtils {
    ...
    public static boolean saveOrUpdateToken(Context context, TokenBean tokenBean){
       // MyLog.e(" tokenBean :"+tokenBean.token);
        ...
        editor.putString(TokenBean.USERNAME, tokenBean.username);
        editor.putString(TokenBean.TOKEN, tokenBean.token);
        editor.commit();
        return true;
    }
    ...
    public static String getTokenStrFromSharedPre(Context context){
        ...
        String token=sp.getString(TokenBean.TOKEN, "");
    ...
    public static TokenBean getTokenFromSharedPre(Context context){
        SharedPreferences sp = context.getSharedPreferences(SHAREDPREFERENCE_NAME, Context.MODE_PRIVATE);
        LoginManager loginManager =new LoginManager();
        TokenBean tokenBean= new TokenBean();

        tokenBean.username=sp.getString(TokenBean.USERNAME,"");
        tokenBean.token=sp.getString(TokenBean.TOKEN, "");
