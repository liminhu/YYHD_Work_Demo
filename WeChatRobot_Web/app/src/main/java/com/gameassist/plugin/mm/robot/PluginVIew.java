    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.insturct_0:
                if(PluginEntry.Web_weatChat_IsLogin==0){
            ...
            case R.id.insturct_7:
                DialogUtils.showXiaZhuDialog(PluginEntry.currentActivity,203,handler);
       ...
       /*         CommonData.initDifferVersionCommonData(PluginEntry.versionCode);
                ...
                MyLog.e(data);*/
    /*            if(PluginEntry.Web_weatChat_IsLogin){
                    PluginEntry.chatroom_nickname= CommonUtils.getChatRoomNickName(PluginEntry.getInstance().getTargetApplication(), PluginEntry.currentActivity);
