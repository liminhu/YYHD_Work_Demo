...
public class WebViewClientBase extends WebViewClient {
    ...
    public WebViewClientBase(MyProgressDialog progressDialog){
    ...
    private void addButtonClickListner(WebView view, String url){
        ...
        if(url.contains("pan.baidu.com")) {
            ...
            //String test_js="javascript: Object.defineProperty(this,'navigator',{value:{platform:\"\"}});";
           // Log.e("hook_baidu.com_begin", "-------------->"+test_js);
           // view.loadUrl(test_js);
